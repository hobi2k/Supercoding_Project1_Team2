...
2. **기초 통계**  
   1. 데이터 프로파일링:
      - 데이터가 가진 특성 분석
   2. 데이터 전처리
   3. 시대별, 장르별 Rates, Votes, Gross 평균 시각화
   4. 장르 상관없이 Rates, Votes, Gross 평균 시각화
   5. 주요 사건, 도시화, GDP, 영화 제작 편수 등 외부 지표와 데이터의 상관관계 출력
...
- **데이터/작업물 공유**
  ...
  - 모든 공유 작업에는 문서화(예: README.md) 및 공통화(예: 코드 주석) 수행 
